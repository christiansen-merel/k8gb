...
func (r *GslbReconciler) gslbIngress(gslb *k8gbv1beta1.Gslb) (*v1.Ingress, error) {
...
func (r *GslbReconciler) saveIngress(instance *k8gbv1beta1.Gslb, i *v1.Ingress) error {
	found := &v1.Ingress{}
...
func ingressEqual(ing1 *v1.Ingress, ing2 *v1.Ingress) bool {
